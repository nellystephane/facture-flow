...
import {
  ...
  Wallet, FileText, ArrowRight, Plus, BarChart3
} from 'lucide-react';
...
export default function Dashboard() {
  ...
  const maxRevenu = Math.max(...revenusMensuels.map((r) => r.total), 1);
      ...
      {data?.statistiquesAvancees ? (
        ...
        <div className="mb-8 animate-fade-up delay-2">
          <LockedFeature
            ...
            description="Visualisez l'évolution de votre chiffre d'affaires sur 6 mois et identifiez vos meilleurs clients d'un coup d'œil."
            planRequis="Pro"
          />
        </div>
      )}
