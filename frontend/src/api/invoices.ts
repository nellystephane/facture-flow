...
import type { Invoice, InvoiceStatut, Paginated } from '../types';

export const getInvoices = (params?: { statut?: string; client?: string; q?: string; page?: number; limit?: number }) =>
...
// URL absolue vers le backend — indispensable quand frontend et backend ne
// sont pas sur le même domaine (ex: GitHub Pages + Render).
export const invoicePdfUrl = (id: string) => `${API_BASE_URL}/invoices/${id}/pdf`;
export const invoicesExportUrl = () => `${API_BASE_URL}/invoices/export`;
