      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          <form onSubmit={handleSubmit} className="glass-card p-6 animate-fade-up">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <div className="relative">
                  <Phone size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 z-10" />
          ...
          <form onSubmit={handleChangePassword} className="glass-card p-6 animate-fade-up delay-1">
            <h3 className="font-bold text-[#0a0a0c] mb-1 flex items-center gap-2"><Lock size={16} /> Sécurité</h3>
            <p className="text-xs text-gray-400 mb-5">Changez votre mot de passe. Vous resterez connecté sur cet appareil.</p>
            <div className="grid sm:grid-cols-2 gap-4">
              <div className="sm:col-span-2">
                <label className="field-label">Mot de passe actuel</label>
                <div className="relative">
                  <KeyRound size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 z-10" />
            ...
            <p className="text-xs text-gray-400 mt-2">Au moins 8 caractères, avec un caractère spécial (ex: ! ? # @ % &).</p>
