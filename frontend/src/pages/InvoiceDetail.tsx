...
import {
  ...
  Send, CheckCircle2, Clock, XCircle, Mail, Link2, Receipt, Loader2, Lock
} from 'lucide-react';
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 mb-6 animate-fade-up">
        ...
        <div className="flex flex-wrap gap-2 items-center">
          ...
          {invoice.statut === 'brouillon' ? (
            ...
            <span className="text-xs text-gray-400 flex items-center gap-1" title="Une facture envoyée ne peut plus être modifiée ni supprimée, pour garantir une numérotation fiable. Utilisez le statut « Annulée » si besoin.">
